...
def export(obj, filename, fontsize=14, max_rows=None, max_cols=None,
           table_conversion='chrome', chrome_path=None, background_color=BACKGROUND_COLOR_DEFAULT):
    return _export(obj, filename, fontsize, max_rows, max_cols, table_conversion, chrome_path, background_color)


def _export(obj, filename, fontsize, max_rows, max_cols, table_conversion, chrome_path, background_color=BACKGROUND_COLOR_DEFAULT):
    ...
    if table_conversion == 'chrome':
        ...
        converter = TableMaker(fontsize=fontsize, encode_base64=False,
                               for_document=False, background_color=background_color).run
